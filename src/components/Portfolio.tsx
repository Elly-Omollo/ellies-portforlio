        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block">
              <div className={`relative w-full h-96 ${darkMode ? 'bg-linear-to-br from-blue-500/20 to-purple-600/20' : 'bg-gradient-to-br from-blue-500/10 to-purple-600/10'} rounded-2xl animate-pulse-slow`}>
